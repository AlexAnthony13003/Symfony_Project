 ...
 */
final class Version20230518171117 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE ingredient RENAME INDEX fk_user TO IDX_6BAF7870A76ED395');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE ingredient RENAME INDEX idx_6baf7870a76ed395 TO FK_User');
    }
}
